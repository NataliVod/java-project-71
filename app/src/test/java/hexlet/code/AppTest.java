...
class AppTest {
    ...
    @Test
    void testStylishDifferGenerateJson() throws Exception {
    ...
    @Test
    void testStylishDifferGenerateYml() throws Exception {
    ...
    @Test
    void testPlainDifferGenerateJson() throws Exception {
        String path1 = "src/test/resources/file1.json";
        String path2 = "src/test/resources/file2.json";
    ...
    @Test
    void testPlainDifferGenerateYml() throws Exception {
        String path1 = "src/test/resources/file1.yml";
        String path2 = "src/test/resources/file2.yml";
        String result = Differ.generate(path1, path2, "plain");
        assertThat(result).isEqualTo(plainExpected);
